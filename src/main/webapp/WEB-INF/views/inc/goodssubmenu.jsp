...
<!-- Sidebar -->
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <h6 class="dropdown-header">상품 소분류:</h6>
            <a class="dropdown-item" href="login.html">카메라</a>
            <a class="dropdown-item" href="register.html">음향기기</a>
            <a class="dropdown-item" href="forgot-password.html">게임</a>
			<a class="dropdown-item" href="forgot-password.html">PC/노트북</a>
			<a class="dropdown-item" href="forgot-password.html">PC주변기기</a>
			<a class="dropdown-item" href="forgot-password.html">휴대폰</a>
          </div>
        </li>
